...
import com.example.dexdogs.activities.MainActivity
...
import com.example.dexdogs.viewmodel.AuthViewModel

class LoginActivity : AppCompatActivity(), LoginFragment.LoginFragmentListener, SignupFragment.SignupFragmentListener {
